...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": ["http://localhost:3000", "http://172.27.4.144:3000", "http://10.97.13.249:3000"]}})  # Enable CORS for your React app's origin

# Add a route to render the HTML file
